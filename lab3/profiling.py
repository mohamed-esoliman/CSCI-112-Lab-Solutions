...
File: profiling.py
(I have changed the file name from profile.py to profiling.py because profile causes a problem of overriding a std python library called profile)
...
from fibs import fib1, fib2, fib2_helper
from sorts import selectionSort, quickSort, swap
...
def main():
    ...
    profileSort(selectionSort, 13)
    profileSort(quickSort, 13)
